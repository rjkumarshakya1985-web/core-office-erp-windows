...
namespace CoreOffice.Win.Modules.Cashier.Invoices
{
    public partial class InvoiceForm : Form
    {
        ...
        public InvoiceForm(IServiceProvider serviceProvider
        ...
        public async Task LoadBillByVisitor(int visitorId)
        {
            ...
            {
                MessageBox.Show($"Packing slip not found for the visitor for billing", "Found", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
