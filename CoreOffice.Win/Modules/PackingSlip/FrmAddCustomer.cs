...
namespace CoreOffice.Win.Modules.PackingSlip
{
    public partial class FrmAddCustomer : BaseForm
    {
        ...
        public FrmAddCustomer(ICustomerService customerService, IMasterService masterService)
        {
            InitializeComponent();
        ...
        private bool ValidateCustomer()
        {
            ...
            if (!string.IsNullOrWhiteSpace(txtPhone.Text) && txtPhone.Text.Trim().Length != 10)
                return ShowValidationError("Mobile must be exactly 10 digits.", txtPhone);
