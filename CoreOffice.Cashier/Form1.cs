...
namespace CoreOffice.Cashier
{
    public partial class Form1 : Form
    {
        ...
        void btnVendorGroup_Click(object sender, EventArgs e)
        {
            ...
            vendorGroup.oldGroupName = "K P Agency (BO) (TBT)";

            vendorGroup.groupName = "K P Agency (BO) (TBT)";
        ...
        void btnVendorMaster_Click(object sender, EventArgs e)
        {
            ...
            vendorLedger.oldLedgerName = "9NX DESIGNER, SURAT (TBT)";

            vendorLedger.ledgerName = "9NX DESIGNER, SURAT (TBT)";

            //Mailing Name of the vendor master
            vendorLedger.ledgerMailingName = "9NX DESIGNER";
            ...
            vendorLedger.email = "accounts@9nxdesigner.com";
            vendorLedger.emailCc = "manager@9nxdesigner.com";
            vendorLedger.website = "www.9nxdesigner.com";

            vendorLedger.gstin = "24AROPP2114P1ZF";

            //Valid values as per Tally dropdown: "Regular", "Composition", "Unregistered/Consumer"
            vendorLedger.gstRegistrationType = "Regular";

            vendorLedger.panNo = "AROPP2114P";
